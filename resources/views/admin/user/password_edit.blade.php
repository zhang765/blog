...
<script type="text/javascript" src="{{URL::asset('js/Validform_v5.3.2_min.js')}}"></script>
<script type="text/javascript" src="{{URL::asset('layer/layer.min.js')}}"></script>
<script type="text/javascript" src="{{URL::asset('js/H-ui.js')}}"></script>
<script type="text/javascript" src="{{URL::asset('js/H-ui.admin.js')}}"></script>
